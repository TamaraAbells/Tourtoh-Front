...
const ThingsToDo = ({ Asset, sliderAsset }) => {
  return (
    <>
      <Stack>
        <Grid
        ...
        >
          <GridItem
            ...
            cursor="pointer"
          >
            <Image src={Asset.Image.Rectangle4} w="100%" height="100%" />
          </GridItem>
          <GridItem
            colSpan={1}
            borderRadius="20px"
            ...
            cursor="pointer"
          >
            <Image src={Asset.Image.Rectangle2} w="100%" height="100%" />
          </GridItem>
          <GridItem
            rowSpan={2}
            colSpan={2}
            ...
            cursor="pointer"
          >
            <Image src={Asset.Image.Rectangle1} w="100%" height="100%" />
          </GridItem>
          <GridItem
            colSpan={1}
            borderRadius="20px"
            ...
            cursor="pointer"
          >
            <Image src={Asset.Image.Rectangle3} w="100%" height="100%" />
          </GridItem>
          <GridItem
            colSpan={1}
            borderRadius="20px"
